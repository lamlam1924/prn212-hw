...
namespace DesignPatterns.Homework
{
    ...
    public class CurrentConditionsDisplay : IWeatherObserver
    {
        ...
        public void Display()
        {
            Console.WriteLine($"[Current Conditions] Temp: {_temperature}°C, Humidity: {_humidity}%, Pressure: {_pressure} hPa");
        }
    }
    ...
    public class StatisticsDisplay : IWeatherObserver
    {
        ...
        public void Display()
        {
            ...
            Console.WriteLine($"[Statistics] Min: {_minTemp}°C, Max: {_maxTemp}°C, Avg: {avg:F2}°C");
        }
    }
    ...
    public class ForecastDisplay : IWeatherObserver
    {
        ...
        public void Display()
        {
            ...
            Console.WriteLine($"[Forecast] Prediction: {forecast}");
        }
    }
